      ...
      <footer className="bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-xl font-bold">MicroPlastics India</span>
              </div>
              <p className="text-gray-400">
                Leading manufacturer and supplier of high-quality plastic materials and recycled products.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-gray-400 mb-2">Email: info@microplasticsindia.com</p>
          ...
          <div className="border-t border-gray-800 pt-8 mt-8 text-center text-gray-400">
            <p>&copy; 2025 MicroPlastics India. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
